// BMAD-Cortex Integration Module
// Provides the integration layer between BMAD AI Agent Orchestrator and Cortex Research Platform
...
/// Main integration service that coordinates BMAD agents and Cortex research engine
